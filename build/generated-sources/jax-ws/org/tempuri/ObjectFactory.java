...
public class ObjectFactory {
    ...
    private final static QName _UpdateBookName_QNAME = new QName("http://tempuri.org/", "name");
    ...
    public JAXBElement<String> createUpdateBookName(String value) {
        return new JAXBElement<String>(_UpdateBookName_QNAME, String.class, UpdateBook.class, value);
    }
    ...
    public JAXBElement<String> createGetBooksByNameName(String value) {
        return new JAXBElement<String>(_UpdateBookName_QNAME, String.class, GetBooksByName.class, value);
    }
    ...
    public JAXBElement<String> createAddBookName(String value) {
        return new JAXBElement<String>(_UpdateBookName_QNAME, String.class, AddBook.class, value);
    }
